	...
	return (
		...
		>
			<Dithering
				...
				colorBack="#00000000"
				colorFront="#305C3FCC"
				className="!w-full !h-full opacity-100 absolute bg-[#0000004D] left-0 top-0"
			/>
			<SmokeRing
				speed={0.32}
				scale={0.88}
			...
			<Dithering
				...
				colorBack="#00000000"
				colorFront="#3A5B37CC"
				className="!w-full !h-full opacity-100 absolute bg-[#FFF6F44D] left-0 top-0"
			/>
			<PaperTexture
				contrast={0.3}
				roughness={0.4}
				...
				colorBack="#00000000"
				colorFront="#21914B"
				className="!w-full !h-full opacity-45 absolute bg-[#FFFFFF63] left-0 top-0"
			/>
		</div>
	);
}
